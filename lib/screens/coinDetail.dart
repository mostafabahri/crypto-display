                  ...
                  children: <Widget>[
                    new Expanded(
                      ...
                      child: new Column(children: <Widget>[
                        new Row(
                          children: <Widget>[
                            new Text('Ranked ${_rankText(coin.rank)}', style: new TextStyle(
                              fontSize: 20.0,
                      ...
                      new Row(
                        ...
                        children: <Widget>[
                          new Column(
                            crossAxisAlignment : CrossAxisAlignment.start,
                            children: <Widget>[
                              new Text('1 Hour', style: secondaryTextStyle,),
                              new Text('24 Hour', style: secondaryTextStyle,),
                              new Text('7 Days', style: secondaryTextStyle,),
                          ...
                          new Column(
                            ...
                            children: <Widget>[
                              new Text('${coin.change1Hour}%', style: secondaryTextStyle,),
                              new Text('${coin.change24Hour}%', style: secondaryTextStyle,),
                              new Text('${coin.change7Days}%', style: secondaryTextStyle,),
